...
public class Logicos extends javax.swing.JInternalFrame {
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        ...
        if (resp) JOptionPane.showMessageDialog(this, "Si es menor", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(this, "No es menor", "Respuesta", JOptionPane.WARNING_MESSAGE);
